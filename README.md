...
Scrum2B is developed by ScrumTobe Team.
...
**The version 2.0 is completed to add more features allow Scrum2B users get more advances:**
...
4. The plugin could run with many Redmine plugins.
